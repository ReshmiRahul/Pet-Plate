...
namespace PetAdoption.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        /// <summary>
        /// Returns a list of Accounts for a specific Pet by its {id}
        /// </summary>
        /// <returns>
        /// 200 OK
        /// [{AccountDto},{AccountDto},..]
        /// </returns>
        /// <example>
        /// GET: api/Account/ListForPet/3 -> [{AccountDto},{AccountDto},..]
        /// </example>
        [HttpGet(template: "ListForPet/{id}")]
        public async Task<IActionResult> ListAccountsForPet(int id)
        {
            // empty list of data transfer object AccountDto
            IEnumerable<AccountDto> AccountDtos = await _accountService.ListAccountsForPet(id);
            // return 200 OK with AccountDtos
            return Ok(AccountDtos);
        }

        /// <summary>
        /// Unlinks a Account from a Pet
        /// </summary>
        ...
        /// </returns>
        /// <example>
        /// Delete: api/Account/Unlink?AccountId=4&Petid=12
        /// ->
        /// Response Code: 204 No Content
        /// </example>
        [HttpDelete("Unlink")]
        public async Task<ActionResult> Unlink(int AccountId, int PetId)
        {
            ServiceResponse response = await _accountService.UnlinkAccountFromPet(AccountId, PetId);
        ...
        /// </returns>
        /// <example>
        /// Post: api/Account/Link?AccountId=4&Petid=12
        /// ->
        /// Response Code: 204 No Content
        /// </example>
        [HttpPost("Link")]
        public async Task<ActionResult> Link(int AccountId, int PetId)
        {
            ServiceResponse response = await _accountService.LinkAccountToPet(AccountId, PetId);
